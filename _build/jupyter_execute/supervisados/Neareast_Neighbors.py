...
# 
# 
# ![excellKNN.PNG](figuras/excellKNN.PNG)
# 
...
# 
# ![valor_k.PNG](figuras/valor_k.PNG)
# 
...
knn.fit(X_train, y_train)
print('El accuracy en el conjunto de entrenamiento es: {:.2f}'.
        format(knn.score(X_train, y_train)))
print('El accuracy en el conjunto de test es: {:.2f}'.
